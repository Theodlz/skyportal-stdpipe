...
# lines to comment if you do not want to use the image analysis feature with STDPIPE
RUN apt-get update && \
...
# lines to uncomment if you do not want to use the image analysis feature with STDPIPE
